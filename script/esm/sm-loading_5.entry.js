...
const StockFinder = class {
    ...
    render() {
        let data;
        if (this.symbols) {
            data = h("ul", null, this.symbols.map(res => (h("li", { onClick: this.onSelectSymbol.bind(this, res.symbol) }, h("strong", null, res.symbol), ": ", res.name))));
        }
        ...
        return [
            h("form", null, h("input", { ref: el => this.input = el, value: this.stockSymbol, placeholder: this.placeholder, onInput: this.onInputChange.bind(this) })),
            data,
...
const StockPrice = class {
    ...
    __stencil_render() {
        ...
        return [
            ...
            h("form", null, h("input", { ref: el => this.input = el, value: this.stockSymbol, onInput: this.onInputChange.bind(this) })),
            h("div", null, data)
        ];
    }
    static get watchers() { return {
